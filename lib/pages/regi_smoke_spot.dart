  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: _isTakingPicture ? _buildCameraView() : _buildDetailsView(),
      ),
    );
  }
                  ...
                  child: FloatingActionButton(
                    onPressed: () async {
                      ...
                      if (picture != null && mounted) {
                        ...
                        await _getAddressFromCoordinates(widget.lat, widget.lng);
                      }
                    },
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Image.file(File(_picture!.path), width: 200, height: 200), // 사진을 더 크게 표시합니다.
